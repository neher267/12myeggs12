	...
	<div class="panel panel-widget forms-panel">
		<div class="forms">
			<div class="form-grids widget-shadow" data-example-id="basic-forms"> 
				...
				<div class="col-md-12">
					<a href="{{route('mix-products.images.index',$product)}}" class="btn btn-default"><i class="fas fa-arrow-circle-left green-btn"></i>Back</a>
				...
				<div class="form-body">
					<form action="{{route('mix-products.images.store', $product)}}" method="POST" enctype="multipart/form-data">
					{{ csrf_field() }}					
