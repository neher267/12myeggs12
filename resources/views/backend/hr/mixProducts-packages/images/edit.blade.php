	...
	<div class="panel panel-widget forms-panel">
		<div class="forms">
			<div class="form-grids widget-shadow" data-example-id="basic-forms"> 
				...
				<div class="col-md-12">
					<a href="{{route('mix-products.package.images.index',[$product_id, $package_id])}}" class="btn btn-default">Back</a>
				...
				<div class="form-body">
					<form action="{{route('mix-products.package.images.update',[$product_id, $package_id, $image])}}" method="POST" enctype="multipart/form-data">
					{{ csrf_field() }}		
					{{ method_field('PUT') }}					
