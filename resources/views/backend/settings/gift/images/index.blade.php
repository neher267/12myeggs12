...
<div class="grids">
	<div class="panel panel-widget forms-panel">
		<div class="forms">
			<div class="row">
				<div class="col-md-12">
					<a href="{{route('gifts.index')}}" class="btn btn-default">Back</a>
					<a href="{{route('gift.images.create', $gift)}}" class="btn btn-default">Add New Image</a>		
					...
					<table class="table table-striped table-bordered datatable" cellspacing="0"	>
						...
						@foreach($images as $image)
							<tr>
								...
								<td>
									<a href="{{route('gift.images.edit', [$gift, $image])}}" class="btn btn-default">Edit</a>
